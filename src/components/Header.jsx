...
const Header = () => {
  ...
  return (
    ...
    >
      ...
      mt-8 px-12 py-2.5 flex items-center gap-2 rounded-full hover:scale-105 transition-all duration-200'
      ...
      className='mt-4 text-neutral-600 '>
        Generated Images from <span className='font-semibold'>Text2Art</span> 
      </motion.p>
