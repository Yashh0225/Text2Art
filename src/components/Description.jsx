...
const Description = () => {
  ...
  viewport={{ once: true }}
    className='flex flex-col items-center justify-center my-24 p-6 md:px-28 text-center'>
      ...
      <div className='flex flex-col gap-5 md:gap-14 md:flex-row items-center'>
        <img src={assets.sample_img_1} className='w-80 = s=xl:w-96 rounded-lg'
        />

        <div className='flex flex-col gap-4 max-w-lg'>

          <h2 className='text-3xl font-medium max-w-lg mb-4'>Introducing the <span className='text-blue-500'>AI-Powered</span> Text to Image Generator</h2>
